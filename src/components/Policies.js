...
export default (props) => (
  <>
    <div id="policies" className="policies modal">
      <div className="inner">
        <h3>Policies</h3>
        <label htmlFor="closed" className="close-modal menu-toggle-button">
        ...
        <label htmlFor="closed" className="brand-button">
          Close <i className="fa fa-close"></i>
        </label>
      </div>
    </div>
    <label htmlFor="closed" className="policies-bg modal-bg"></label>
  </>
);
